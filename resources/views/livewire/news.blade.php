                    ...
                    <div class="mt-5 md:mt-0 md:col-span-3">
                        ...
                        <div class="overflow-hidden shadow sm:rounded-md">
                            <div class="px-4 py-5 bg-white sm:p-6">
                                <h1 class="text-6xl font-black">Community News</h1>
                                        <p class="mt-3 mb-4 text-lg text-gray-700">Here you can update some text about the latest news happening in your community.</p>
