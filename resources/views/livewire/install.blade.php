<div  x-data="{ step: @entangle('step') }">
    ...
    <section x-show="step==0"
        ...
        <div  class="flex flex-col items-start mx-auto space-y-6 max-w-7xl">
            <h1 class="text-4xl font-bold">Welcome to <br><span class="text-green-400">Climate Clock</span></h1>
            <p class="text-lg text-gray-500">Let's configure a few things and get your climate community setup. This will only take 30 seconds.</p>
    ...
    <section x-show="step==1"
        ...
        <div  class="flex flex-col items-start mx-auto space-y-6 max-w-7xl">
            <h1 class="text-4xl font-bold">About Your <span class="text-green-400">Community</span></h1>
            <p class="text-lg text-gray-500">First, enter a little information about your awesome Community.</p>
            ...
            <div class="flex space-x-4">
                <div @click="step--" class="inline-flex items-center px-5 py-3 text-xs font-semibold tracking-widest text-gray-800 uppercase transition duration-150 ease-in-out bg-gray-200 border border-transparent rounded-md cursor-pointer">Previous</div>
    ...
    <section x-show="step==2"
        ...
        <div  class="flex flex-col items-start mx-auto space-y-6 max-w-7xl">
            <h1 class="text-4xl font-bold">Create Your <span class="text-green-400">Account</span></h1>
            <p class="text-lg text-gray-500">Next, create your account. This will give you access to your community dashboard.</p>
    ...
    <section x-show="step==3"
        ...
        class="flex flex-col justify-center h-screen" x-cloak>
        <div  class="flex flex-col items-start mx-auto space-y-6 max-w-7xl">
            <h1 class="text-4xl font-bold">Finsh Your <span class="text-green-400">Setup</span></h1>
            <p class="text-lg text-gray-500">Awesome 🙌, click on finish to complete the install and login to your dashboard.</p>
            <div class="flex space-x-4">
                <div @click="step--" class="inline-flex items-center px-5 py-3 text-xs font-semibold tracking-widest text-gray-800 uppercase transition duration-150 ease-in-out bg-gray-200 border border-transparent rounded-md cursor-pointer">Previous</div>
                <div wire:click="finish" class="inline-flex items-center px-5 py-3 text-xs font-semibold tracking-widest text-white uppercase transition duration-150 ease-in-out bg-green-400 border border-transparent rounded-md cursor-pointer hover:bg-green-500 active:bg-green-500 focus:outline-none focus:border-green-500 focus:shadow-outline-green disabled:opacity-25">Finish</div>
            </div>
        </div>
    </section>
        ...
        <div class="fixed bottom-0 z-50 flex items-center justify-between w-full max-w-sm mx-auto mb-10 ml-1">
            ...
            <div :class="{ 'bg-green-400 border-transparent' : step >= 2, 'border-green-400 bg-gray-100' : step < 2 }" class="relative flex items-center justify-center w-4 h-4 border-4 rounded-full"></div>
            <div :class="{ 'bg-green-400 border-transparent' : step >= 3, 'border-green-400 bg-gray-100' : step < 3 }" class="relative flex items-center justify-center w-4 h-4 border-4 rounded-full"></div>
        </div>
