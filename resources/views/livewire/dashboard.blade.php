<div class="p-5 pt-0">
        ...
        <div class="flex w-full space-x-8">
            ...
            <div class="w-1/2 mx-0 mb-5 overflow-hidden bg-white border border-gray-100 rounded-lg shadow-sm">
                <div class="flex flex-col">
                    ...
                    <div class="flex justify-between items-center p-5 space-x-4 @if($shift){{ 'bg-green-400' }}@else{{ 'bg-gray-200' }}@endif">
                        @if($shift)
                            <p class="pl-1 font-bold text-white">You are currently online</p>
                        @else
                            <p class="pl-1 font-semibold text-gray-500">You are currently not online</p>
                        @endif
            ...
            <div class="w-1/2 pt-2 mx-0" wire:poll.10ms>
                <h1 class="pt-2 pb-6 text-lg font-bold text-gray-700 md:text-xl">📰 Latest Community News</h1>
                <div class="h-24 text-sm text-gray-600 bg-white border border-gray-100 rounded-lg shadow-sm">
                    ...
                    @else
                            ...
                            <p class="p-5">No latest Community news posted.
                            @if(auth()->user()->hasTeamRole(auth()->user()->currentTeam, 'manager'))
                                <a href="/news" class="text-green-500 underline">Click here to add Community news</a>
                            @endif
                            </p>
                    @endif
                </div>
            ...
            <div class="flex justify-between mx-auto mt-5 space-x-8">
                <div class="w-1/2">
                    <div class="flex items-center justify-between px-1">
                        <h1 class="text-lg font-bold text-gray-700 md:text-xl">🍕 <span class="ml-2">Your Community Feed</span></h1>
                    </div>
                    <div>
                        @livewire('posts')
                    </div>
                ...
                <div class="w-1/2 rounded-lg shadow-sm">
                    <div class="flex items-center justify-between px-1 pb-6">
                        <h1 class="text-lg font-bold text-gray-700 md:text-xl">⚔️ <span class="ml-2">Community Members</span></h1>
                    </div>
                        <div class="relative">
